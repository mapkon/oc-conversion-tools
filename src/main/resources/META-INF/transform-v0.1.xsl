...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:odm="http://www.cdisc.org/ns/odm/v1.3"
	...
	<xsl:template name="createRangeConstrainsts">
		...
		<xsl:if test="$pItemDef/*[local-name()='RangeCheck'][position()=1]/@Comparator = 'GT'">
		...
		<xsl:if test="$pItemDef/*[local-name()='RangeCheck'][position()=1]/@Comparator = 'LE'">
		...
		<xsl:if test="$pItemDef/*[local-name()='RangeCheck'][position()=1]/@Comparator = 'GE'">
		...
		<xsl:if test="$pItemDef/*[local-name()='RangeCheck'][position()=1]/@Comparator = 'EQ'">
